...
public class Customermodel {
    ...
    public Customermodel(String token, String cust_name, String cust_phoneno, String cust_address, String cust_pincode, String gender, String cust_email, String cust_password, String profile_photo) {
        this.token = token;
